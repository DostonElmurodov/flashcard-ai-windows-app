...
export interface Bridge {
 ...
 backup():Promise<boolean>; restore():Promise<boolean>; account():Promise<AccountState>; login(email:string,password:string,confirmation?:string):Promise<AccountState>; logout():Promise<void>; deleteAccount():Promise<void>; refreshEntitlement():Promise<AccountState>;
