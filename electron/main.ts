...
if(!app.requestSingleInstanceLock())app.quit();else{
 ...
 app.whenReady().then(async()=>{try{
  ...
  register();configureLogin();configureTray();await window.loadFile(join(__dirname,'../dist/index.html'));window.webContents.setZoomLevel(-.5);window.show();
