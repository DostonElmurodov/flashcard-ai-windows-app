...
const defaults:Settings={nativeLanguage:'ru',learningLanguage:'en-us',theme:'light',accent:'indigo',darkAccent:'teal',dailyGoal:5,direction:'forward',dayStart:240,retention:.9,reminders:false,reminderTime:'19:00',reminderStart:'08:00',reminderEnd:'20:00',reminderCount:10,keepInTray:false,launchAtLogin:false,apiBase:'https://api.mavrylo.com',onboardingComplete:false};
export class Store {
